...
public class DummyDataService {
    ...
    public void generateDummyData(Member member) {
        ...
        Claim claim = Claim.builder()
                ...
                .member(member)
                .provider(provider)
                .serviceStartDate(LocalDate.now().minusDays(10))
                .serviceEndDate(LocalDate.now().minusDays(5))
                .receivedDate(LocalDate.now().minusDays(3))
                .status(ClaimStatus.SUBMITTED)
                .totalBilled(new java.math.BigDecimal("1200.00"))
                .totalAllowed(new java.math.BigDecimal("800.00"))
                .totalPlanPaid(new java.math.BigDecimal("600.00"))
                .totalMemberResponsibility(new java.math.BigDecimal("200.00"))
